    ...
    <>
      ...
      <section className="about-section sec-pad">
        <div
          ...
          style={{ backgroundImage: `url(${pattern_layer})` }}
        ></div>
              ...
              <div className="image_block_eight">
                ...
                >
                  <div className="shape">
                    <div
                      className="shape-1"
                      style={{ backgroundImage: `url(${shape_1})` }}
                    ></div>
                    <div
                      className="shape-2"
                      style={{ backgroundImage: `url(${shape_1})` }}
              ...
              <div className="content_block_one">
                <div className="content-box p_relative d_block ml_30">
                  ...
                  <div className="text p_relative d_block mb_30">
                    <p>
                      Capricorn is a registered company in the UAE, The Head
                      office and workshop is located in Abu Dhabi, So we can
                      deliver a more convenient service to our clients across
                      the UAE. Capricorn MEP is part of organization established
                      and in full operation Since 2018. After a couple of years
                      we have proven our position in the market in the field of
                      Construction and M EP Services by being one of the fastest
                      growing companies in the Region. Capricorn M EP
                      understands clearly the needs of each company
                      participating in various Projects. Every client has its
                      own distinctive requirement and we are committed to
                      providing the best and suitable solutions in terms of
                      Engineering Design, Supply, Execution and after sales
                      services. Capricorn MEP employs professional staff who
                      will certainly assist you from the design and planning
                      stage until the successful implementation. Our team is
                      equipped with the latest machinery equipment, tools
                      materials and most of all skilled nd dedicated workers.
                    </p>
                  </div>
