...
const Nav = () => {
  return (
    <>
      ...
      <div classNameName="loader-wrap">
        <div classNameName="preloader">
          <div classNameName="preloader-close">x</div>
          <div id="handle-preloader" classNameName="handle-preloader">
            <div classNameName="animation-preloader">
              <div classNameName="spinner"></div>
              <div classNameName="txt-loading">
                <span data-text-preloader="e" classNameName="letters-loading">
                  e
                </span>
                <span data-text-preloader="a" classNameName="letters-loading">
                  a
                </span>
                <span data-text-preloader="s" classNameName="letters-loading">
                  s
                </span>
                <span data-text-preloader="t" classNameName="letters-loading">
                  t
                </span>
                <span data-text-preloader="o" classNameName="letters-loading">
                  o
                </span>
                <span data-text-preloader="n" classNameName="letters-loading">
                  n
                </span>
              </div>
            </div>
        ...
        {/* <div id="search-popup" className="search-popup">
            <div className="popup-inner">
                <div className="upper-box clearfix">
                    <figure className="logo-box pull-left"><a href="index.html"><img src="assets/images/logo.png" alt=""></a></figure>
                ...
                <div className="outer-box">
                    <div className="menu-area clearfix">
                        <div className="logo-box">
                            <figure className="logo"><a href="index.html">
                              <img src="{logo}" alt=""/>
                            </a></figure>
                        </div>
                    ...
                    <div className="nav-right">
                        <div className="support-box">
                            <h6><i className="icon-4"></i>Call: <a href="tel:123045615523">+1 (230)-456-155-23</a></h6>
                        </div>
